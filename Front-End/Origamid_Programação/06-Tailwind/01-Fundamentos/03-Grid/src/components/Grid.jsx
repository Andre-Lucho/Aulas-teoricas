...
const Grid = () => {
  return (
    <>
      <div class="grid grid-cols-2 gap-x-4 gap-y-8 *:bg-gray-500">
      ...
      <br />
      <div class="grid grid-cols-[minmax(0,300px)_1fr] gap-2 *:bg-gray-500 *:p-4">
        <div>minmax(0,300px)</div>
        <div>1fr</div>
      </div>
      <br />
      <div class="grid grid-cols-3 gap-2 *:bg-gray-500 *:p-4">
