...
### Com o Type Assertion é possível "indicar" ao TypeScript qual o tipo de dado esperado com a palavra-chave as.<br> Só é possível indicar tipos que possuam relação com o tipo original.
