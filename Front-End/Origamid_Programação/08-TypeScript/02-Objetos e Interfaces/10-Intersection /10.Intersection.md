...
### É possível adicionar uma propriedade a uma interface ou tipo que já definido.
...
- Matém o mesmo nome da interface e adiciona as propriedades
...
- Nomeia os types com nomea diferentes e utiliza o '&' para adicionar novas propriedades
