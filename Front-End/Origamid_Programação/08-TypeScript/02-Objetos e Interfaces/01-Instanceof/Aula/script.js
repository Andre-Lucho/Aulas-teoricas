...
function buscarAutomovel2(busca) {
    if (busca === 'carro')
        return new Carro2('carro', 'Clio');
    if (busca === 'porta')
        return new Portas2('portas', 4);
    else
        return null;
}
...
if (auto2 instanceof Carro2)
    console.log(auto2.marca);
// Tenho disponível as propriedades, tanto da classe, como da classe herdada
if (auto2 instanceof Portas2)
    console.log(auto2.tipo);
