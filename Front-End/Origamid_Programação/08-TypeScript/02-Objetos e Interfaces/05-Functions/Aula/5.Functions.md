...
### Existem funções que retornam diferentes dados dependendo do argumento.<br> Podemos declarar a interface dessas funções utilizando function overload.<br> Basta declarar a interface antes da definição da mesma, utilizando o mesmo nome.<br> O Overload deve ser compatível com a função original.
