...
```typescript
console.log(document.constructor); // f HTMLDocument()
...
- ### Obs.: Ao instanciar uma classe em JS, o TypeScript gera automaticamente a interface dessa classe

<br>

## Modificadores

### Trazem mais segurança os TS. <br>O TypeScript fornece diversas palavras-chave (Modifiers) que podem ser utilizadas em propriedades e/ou métodos de classes para modificar o comportamento/uso das mesmas:

### 1. - public: é o padrão de qualquer uma <br> 2. - private: só pode ser acessada dentro da classe <br> 3. - protected: só pode ser acessada dentro da classe e subclasses <br> 4. - readonly: só permite leitura - não premite modificação.
