...
ver uso --> Utility-Type-Parcial.md
...
### O Record define a interface de um Objeto que possui <chave, tipo>. Pode ser usado para definir a interface de um Objeto Literal genérico quando não sabemos que tipo de valor tem a interface que vamos receber, apenas suas chaves.
