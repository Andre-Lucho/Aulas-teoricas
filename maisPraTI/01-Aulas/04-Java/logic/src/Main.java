...
public class Main {
        public static void main(String[] args) {
                // ocupa 32bits --> valores entre -2bi e + 2bi
                ...
                // valores entre -32mil e 32 mil
                short shortVar = 32767;

                // Números flutuantes:
                double doubleVar = 9223372036854775807.0; // não usar p $
                float floatVar = 9223372036854775807.0f; // add f ao final

                // Variável p caracteres - armazena apenas 1 caracter
                // String --> É um array de char's

                char charVar = 'A';

                boolean booleanVar = true;

                // System.out.println("intVar = " + intVar); // Sempre aspas duplas
                ...
                // Formatado para 2 valores depois da vírgula (float) + com quebra de linha
                // System.out.printf("%.2f \n", floatVar);

                // Tipos de Referência - são Objetos:
                // classe, interface, array, string, enum, record, ...
