...
const ProductGrid = ({ renderProductCard }) => {
  ...
  return (
    <div className="grid-area-[product-grid] w-[95%] mx-auto mt-6">
      <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-3 lg:gap-3">
        {renderProducts()}
      </ul>
    </div>
  );
